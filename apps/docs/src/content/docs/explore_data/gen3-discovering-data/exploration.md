...
![The view on the list of Projects when "Data without Access" is selected.](<../../.gitbook/assets/bdc_dec20_expl_acess_3 (1).png>)

![Example: The variable of Ethnicity is hidden once the number of subjects falls below 50.](<../../.gitbook/assets/bdc_dec20_expl_access_6 (1).png>)
...
![Download files by clicking on the link located under the GUID column.](<../../.gitbook/assets/bdc_dec20_expl_filetab_downloadguid (1).png>)
