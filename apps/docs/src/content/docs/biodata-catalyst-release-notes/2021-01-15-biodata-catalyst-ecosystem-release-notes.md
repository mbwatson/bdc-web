---
title: "2021-01-15 BioData Catalyst Ecosystem Release Notes"
---
...
**CWL tool for Bcftools Merge and Filter:** Users can now find a CWL tool for [BCFtools Merge and Filter](https://platform.sb.biodatacatalyst.nhlbi.nih.gov/public/apps#smgogarten/uw-gac-commit/bcftools-merge-and-filter/) in the Seven Bridges Public Apps Gallery. This tool merges multiple VCF/BCF files from non-overlapping sample sets to create one multi-sample file and filter out any monomorphic variants. This tool is useful when working with input files that contain monomorphic variants like the TOPMed datasets.<br>
