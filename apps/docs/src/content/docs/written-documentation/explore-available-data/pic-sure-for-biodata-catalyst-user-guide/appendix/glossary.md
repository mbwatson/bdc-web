...
| Concept Path           | A unique string or identifier for a variable with a tree-like structure that contains information about the study, dataset, and variable (for example: `/study/dataset/variable/`)   |
...
| Filter                 | An action that describes applying criteria to select a subcohort (for example, filtering to "females" using the sex variable or those with _BRCA1_ high severity genomic variants)   |
...
| Stigmatizing           | Potentially sensitive information that should not be publicly filterable; [see this page for more information](https://github.com/hms-dbmi/biodata_catalyst_stigmatizing_variables)  |
