...
---
import YouTubeEmbed from '@bdc/ui/components/YouTubeEmbed.astro';
import BlockLink from '@bdc/ui/components/link/BlockLink.astro';
...
<BlockLink to="/about/studies/topmed">See a list of the TOPMed data available in BDC</BlockLink>
...
<YouTubeEmbed id="gHeiMYOwPD8" />
<YouTubeEmbed id="pJT9fczTU2o" />
...
<BlockLink to="/about/studies/recover">See a list of the RECOVER data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/bench-to-bassinet">See a list of the Bench to Bassinet data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/biolincc">See a list of the BioLINCC data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/c4r">See a list of the C4R data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/connects">See a list of the CONNECTS data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/sickle-cell-disease">See a list of the Cure Sickle Cell Initiative data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/heartshare">See a list of the HeartShare data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/lungmap">See a list of the LungMAP data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/nsrr">See a list of the NSRR data available in BDC</BlockLink>
...
<BlockLink to="/about/studies/petal-network">See a list of the PETAL Network data available in BDC</BlockLink>
